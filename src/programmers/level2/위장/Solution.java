...
3. smoky_makeup
    ...
    public int solution(String[][] clothes) {
        ...
        for (String[] laundry : clothes) {
            String type = laundry[1];
            if (closet.containsKey(type)) {
                Integer num = closet.get(type) + 1;
                closet.put(type, num);
            } else {
                closet.put(type, 1);
            }
        ...
        Iterator<Integer> iterator = closet.values().iterator();
    ...
    public void answer() {
        ...
        //then
        Assert.assertEquals(answer1, solution(clothes1));
        Assert.assertEquals(answer2, solution(clothes2));
    }
}
